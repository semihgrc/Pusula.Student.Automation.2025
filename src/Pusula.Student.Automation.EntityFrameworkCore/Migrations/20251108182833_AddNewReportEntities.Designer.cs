...
namespace Pusula.Student.Automation.Migrations
{
    ...
    [Migration("20251108182833_AddNewReportEntities")]
    partial class AddNewReportEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pusula.Student.Automation.LessonDailyReports.LessonDailyReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppLessonDailyReports", (string)null);
                });

            modelBuilder.Entity("Pusula.Student.Automation.LessonDailyReports.LessonDailyReportEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DailyComment")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<decimal?>("DailyGrade")
                        .HasPrecision(5, 2)
                    ...
                    b.Property<Guid>("LessonDailyReportId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LessonDailyReportId", "StudentId")
                        .IsUnique();

                    b.ToTable("AppLessonDailyReportEntries", (string)null);
                });

            modelBuilder.Entity("Pusula.Student.Automation.LessonEnrollments.LessonEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppLessonEnrollments", (string)null);
                });

            modelBuilder.Entity("Pusula.Student.Automation.Lessons.Lesson", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Student.Automation.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Student.Automation.LessonDailyReports.LessonDailyReportEntry", b =>
                {
                    b.HasOne("Pusula.Student.Automation.LessonDailyReports.LessonDailyReport", null)
                        .WithMany("Entries")
                        .HasForeignKey("LessonDailyReportId")
            ...
            modelBuilder.Entity("Pusula.Student.Automation.LessonEnrollments.LessonEnrollment", b =>
                {
                    b.HasOne("Pusula.Student.Automation.Lessons.Lesson", "Lesson")
                        .WithMany("Enrollments")
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pusula.Student.Automation.Students.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("Pusula.Student.Automation.Lessons.Lesson", b =>
                {
                    b.HasOne("Pusula.Student.Automation.Teachers.Teacher", "Teacher")
                        .WithMany()
